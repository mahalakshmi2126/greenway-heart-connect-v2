      ...
      if (image) {
        ...
        Object.keys(newBlog).forEach((key) => {
          if (key === "content") {
            ...
            if (newBlog[key]) {
              payload.append(key, newBlog[key]);
            }
          } else {
            payload.append(key, newBlog[key]);
          }
        ...
        payload = { ...newBlog, content: formattedContent };
      }
  ...
  return (
    <div className="min-h-screen bg-background">
                  ...
                  <CardContent>
                    ...
                    <div className="flex space-x-2">
                      ...
                      <Button
                        variant="destructive"
                        size="sm"
                        onClick={() => { setDeleteTargetId(blog._id); setIsDeleteOpen(true); }}
                      >
      ...
      <ConfirmDialog
        ...
        confirmText="Delete"
        onConfirm={() => { handleDeleteBlog(deleteTargetId); setIsDeleteOpen(false); setDeleteTargetId(null); }}
        destructive
      />
      <ConfirmDialog
        open={isLogoutOpen}

  ...
  const handleEditTrustee = async () => {
    ...
    try {
      ...
      if (imageFile) {
        ...
        payload.append("subRole", formState.subRole);
        payload.append("bio", formState.bio);
        payload.append("order", formState.order);
        payload.append("image", imageFile);
      } else {
        payload = {
          name: formState.name,
          role: formState.role,
          subRole: formState.subRole,
          bio: formState.bio,
  ...
  return (
    <div className="min-h-screen bg-background">
                      ...
                      <CardContent className="p-6 text-left flex-grow flex flex-col">
                        ...
                        <div className="flex gap-2 mt-6 pt-4 border-t border-muted">
                          ...
                          <Button
                            size="sm"
                            variant="destructive"
                            onClick={() => { setDeleteTargetId(member._id); setIsDeleteOpen(true); }}
                          >
      ...
      <ConfirmDialog
        ...
        description="Are you sure you want to delete this Board Member? This action cannot be undone."
        confirmText="Delete"
        onConfirm={() => { handleDeleteTrustee(deleteTargetId!); setIsDeleteOpen(false); setDeleteTargetId(null); }}
        destructive
      />
      <ConfirmDialog
        open={isLogoutOpen}

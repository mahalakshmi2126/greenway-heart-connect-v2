...
const AdminPrograms = () => {
  ...
  const [deleteType, setDeleteType] = useState<"event" | "coreProgram" | null>(null);
  ...
  useEffect(() => {
    ...
    const fetchCorePrograms = async () => {
      try {
        ...
        setCorePrograms(Array.isArray(response.data) ? response.data : []);
  ...
  const handleUpdateEvent = async () => {
    ...
    try {
      ...
      if (eventImage) {
        ...
        Object.keys(newEvent).forEach((key) => {
          if (newEvent[key] !== undefined && newEvent[key] !== null) {
            payload.append(key, newEvent[key]);
          }
        });
      ...
      if (coreProgramImage) {
        ...
        Object.keys(newCoreProgram).forEach((key) => {
          if (newCoreProgram[key] !== undefined && newCoreProgram[key] !== null) {
            payload.append(key, newCoreProgram[key]);
          }
        });
        payload.append("image", coreProgramImage);
      } else {
        payload = { ...newCoreProgram };
      }
  ...
  const handleDeleteConfirm = () => {
    ...
    } else if (deleteType === "coreProgram") {
      handleDeleteCoreProgram(deleteTargetId);
    }
  ...
  return (
    <div className="min-h-screen bg-background">
                        ...
                        <div className="absolute inset-0 bg-black/0 group-hover:bg-black/50 transition-all duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100">
                          <div className="flex space-x-2">
                            ...
                            <Button
                              size="sm"
                              variant="destructive"
                              onClick={() => { setDeleteTargetId(program._id); setDeleteType("coreProgram"); setIsDeleteOpen(true); }}
                            >
                  ...
                  >
                    ...
                    <div className="flex space-x-2 p-4">
                      ...
                      <Button
                        variant="destructive"
                        size="sm"
                        onClick={() => { setDeleteTargetId(event._id); setDeleteType("event"); setIsDeleteOpen(true); }}
                      >
      ...
      <ConfirmDialog
        ...
        title={`Delete ${deleteType === "event" ? "Event" : "Core Program"}`}
        description={`Are you sure you want to delete this ${deleteType === "event" ? "event" : "core program"}? This action cannot be undone.`}
        confirmText="Delete"

  ...
  return (
    <div className="min-h-screen bg-background">
                  ...
                  <CardContent>
                    ...
                    <div className="flex space-x-2">
                      ...
                      <Button
                        variant="destructive"
                        size="sm"
                        onClick={() => { setDeleteTargetId(volunteer._id); setIsDeleteOpen(true); }}
                      >
      ...
      <ConfirmDialog
        ...
        confirmText="Delete"
        onConfirm={() => { handleDeleteVolunteer(deleteTargetId); setIsDeleteOpen(false); setDeleteTargetId(null); }}
        destructive
      />
      <ConfirmDialog
        open={isLogoutOpen}

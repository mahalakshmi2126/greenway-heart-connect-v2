  ...
  const handleEditImage = async () => {
    try {
      ...
      if (imageFile) {
        ...
        payload.append("title", newImage.title);
        payload.append("category", newImage.category);
  ...
  return (
    <div className="min-h-screen bg-background">
                      ...
                      <div className="absolute inset-0 bg-black/0 group-hover:bg-black/50 transition-all duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100">
                        <div className="flex space-x-2">
                          ...
                          <Button
                            size="sm"
                            variant="destructive"
                            onClick={() => { setDeleteTargetId(image._id); setIsDeleteOpen(true); }}
                          >
      ...
      <ConfirmDialog
        ...
        confirmText="Delete"
        onConfirm={() => { handleDeleteImage(deleteTargetId); setIsDeleteOpen(false); setDeleteTargetId(null); }}
        destructive
      />

    ...
    const handleUpdateFinancial = async () => {
        ...
        try {
            ...
            if (editPdfFile) {
                ...
                payload.append("year", editYear);
                payload.append("description", editDescription);
                payload.append("pdf", editPdfFile);
            } else {
                payload = {
                    year: editYear,
            ...
            await axios.put(`${API_BASE}/financials/update/${editingFinancial._id}`, payload, {
                headers,
            });
    ...
    return (
        <div className="min-h-screen bg-background">
                                            ...
                                            <div className="flex justify-between items-start">
                                                ...
                                                <div className="flex space-x-1">
                                                    ...
                                                    <Button
                                                        ...
                                                        onClick={() => { setDeleteTargetId(item._id); setIsDeleteOpen(true); }}
                                                    >
            ...
            <ConfirmDialog
                ...
                confirmText="Delete"
                onConfirm={() => { handleDeleteFinancial(deleteTargetId); setIsDeleteOpen(false); setDeleteTargetId(null); }}
                destructive
            />
            <ConfirmDialog
                open={isLogoutOpen}

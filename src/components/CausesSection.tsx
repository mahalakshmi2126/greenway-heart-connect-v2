  ...
  const causes = [
    {
      ...
      description:
        "Supporting para athletes with specialized equipment, training, and opportunities to participate in competitive sports and build confidence.",
      image: photoParaSports,
    },
    {
      id: 101,
    ...
    },
    {
      ...
      description:
        "Supporting children's education through school kits, scholarships, and inclusive learning programs to build a brighter future.",
      image: photoEducation,
    },
  ];
